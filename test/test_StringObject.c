...
void test_getWordAndUpdate_should_get_two_words_from_a_line_with_3_consequence_dot_delimiters() {
	...
	TEST_ASSERT_EQUAL(13, oneLineString.startIndex);
	TEST_ASSERT_EQUAL(0, oneLineString.length);
	TEST_ASSERT_EQUAL(8, subString->startIndex);
	TEST_ASSERT_EQUAL(5, subString->length);
...
void test_getWordAndUpdate_should_get_three_words_from_a_line_with_consequence_dot_delimiters() {
	...
	TEST_ASSERT_EQUAL(3, oneLineString.startIndex);
	TEST_ASSERT_EQUAL(21, oneLineString.length);
	TEST_ASSERT_EQUAL(0, subString->startIndex);
	TEST_ASSERT_EQUAL(3, subString->length);
	...
	TEST_ASSERT_EQUAL(11, oneLineString.startIndex);
	TEST_ASSERT_EQUAL(13, oneLineString.length);
	TEST_ASSERT_EQUAL(8, subString->startIndex);
	TEST_ASSERT_EQUAL(3, subString->length);
	...
	TEST_ASSERT_EQUAL(19, oneLineString.startIndex);
	TEST_ASSERT_EQUAL(5, oneLineString.length);
	TEST_ASSERT_EQUAL(16, subString->startIndex);
	TEST_ASSERT_EQUAL(3, subString->length);
